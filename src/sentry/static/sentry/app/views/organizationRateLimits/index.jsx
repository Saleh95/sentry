      ...
      <div className={className}>
        <div className="controls">
          ...
          <div>
            ...
            <small style={{color: '#666', marginLeft: 5}}> / minute</small>
          </div>
          {this.props.help &&
  ...
  render() {
    ...
    return (
      <form onSubmit={this.onSubmit}>
        <p>Rate limits allow you to control how much data the is stored for this organization. When a rate is exceeded the system will begin discarding data until the next interval.</p>
